...
<body >
  <div class="navbar navbar-expand-lg navbar-dark mb-8" style="background-color:#3ac5c9; margin: 20;" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item active">
                    ...
                    <?php endif; ?>
                    <li class="nav-item ">
                    <a class="nav-link" href="newproduct.php">New</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="bestsale.php">Popular</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="aboutus.php">Contact</a>
                    </li>
            </ul>
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-3" type="search" placeholder="Search" aria-label="Search">
            </form>    
                <a href="login.php" class="mr-sm-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="white" class="bi bi-person" viewBox="0 0 16 16"><path fill-rule="none" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/></svg>
                    ...
                    <a href="favoriteproduct.php" class="mr-sm-3">
