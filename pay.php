                    ...
                    <div class="box">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nameuser" placeholder="Full Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-2">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="tel" class="form-control" placeholder="XXXX-XXXX" required></input>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <textarea class="form-control" placeholder="Your Address" required></textarea>
                            </div>
                        </div>
