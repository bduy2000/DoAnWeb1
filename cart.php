            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="cart.php" medthod ="post">
                        <input type="number" class="form-control" id="quantity" value="<?php echo $bag[$i]['Quantity']?>">
...
function RemoveProduct(){
    document.getElementById("removep").value = document.getElementById("removeproduct").value;
}
</script>
</body>
</html>