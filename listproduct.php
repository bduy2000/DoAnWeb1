...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="font-size:20px"> Libary</li>
  </ol>
  </br>
    ...
    <div class="container">
        ...
        <?php while( $array[$index] && $index<$max): ?>
						<div class="col-sm-3">
                            ...
                            <a href="./productdetail.php?id=<?php echo $array[$index]['Id'] ?>">
								<div class="img-box">
                                <?php echo '<img src="data:image/jpeg;base64,' . base64_encode($array[$index]['Avatar0']) . '" class="img-responsive img-fluid" alt="">'?>
								</div>
        ...
        <?php endwhile;?>
                    ...
                    <div class="center">
                        ...
                        <a href="./listproduct.php?type=<?php echo $type?>&page=<?php if($page - 1 < 1):?><?php $page =1;?><?php echo $page?><?php else:?><?php $new1 =$page-1?><?php echo $new1?><?php endif;?><?php if($userid):?><?php echo '&userid='.$userid?><?php endif;?>">&laquo;</a>
                        <?php while($i <= $slpage): ?>
                        <?php if($i == $page):?>
                            <a href="./listproduct.php?type=<?php echo $type?>&page=<?php echo $i?><?php if($userid):?><?php echo '&userid='.$userid?><?php endif;?>" class="active"><?php echo $i?></a>
                        <?php else:?>
                            <a href="./listproduct.php?type=<?php echo $type?>&page=<?php echo $i?><?php if($userid):?><?php echo '&userid='.$userid?><?php endif;?>"><?php echo $i?></a>
                        <?php endif;?>              
                        <?php $i = $i+1;?>
                        <?php endwhile;?>
                        <a href="./listproduct.php?type=<?php echo $type?>&page=<?php if($page + 1 > $slpage):?><?php echo $page?><?php else:?><?php $new2 = $page + 1;?><?php echo $new2?><?php endif;?><?php if($userid):?><?php echo '&userid='.$userid?><?php endif;?>">&raquo;</a>
                        </div>
                      </div>
	</div>         
