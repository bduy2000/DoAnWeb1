                ...
                <div class="container-fliud">
                    <div class="wrapper row">
                        ...
                        <div class="details col-md-6">
                            ...
                            <h4 class="price">current price: <span><?php echo $getproductdetail['Price']?></span></h4>
                        </div>
                        <form name="form" action="productdetail.php?id=<?php echo $id?>" method="post">
                           ...
                           <input type="submit" class="add-to-cart btn btn-default"  value="Add to Cart">
                            <button button type="button" class="like btn btn-default"><span class="fa fa-heart"></span></button>
                            </div>
                        </form>
                        </div>
                    </div>
